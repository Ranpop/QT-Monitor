...
#include "../../io_layer/savedatathread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SaveDataThread_t, stringdata) + ofs \
...
const QMetaObject SaveDataThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SaveDataThread.data,
      qt_meta_data_SaveDataThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SaveDataThread.stringdata))
