...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SwitchButton_t, stringdata) + ofs \
...
const QMetaObject SwitchButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_SwitchButton.data,
